...
export default function MapView({ userLocation, visibleUsers, isSignalActive }: MapViewProps) {
    ...
    return (
        <div className="relative w-full h-full">
            ...
            <div className="absolute top-4 right-4 z-10 flex flex-col gap-2">
                ...
                <div className="bg-black/90 backdrop-blur-xl rounded-xl p-1 border border-yellow-400/30 shadow-lg">
                    ...
                    >
                        ...
                        <span className={`absolute inset-0 rounded-lg opacity-0 group-hover:opacity-100 transition-opacity ${
                            mapTheme === 'dark' ? 'bg-yellow-400' : 'bg-gray-700'
                        }`}></span>
                    </button>
                </div>
                ...
                <div className="bg-black/90 backdrop-blur-xl rounded-xl p-1 border border-yellow-400/30 shadow-lg">
                    <button
                        ...
                        className="px-4 py-3 rounded-lg transition-all font-bold text-sm bg-gradient-to-r from-yellow-400 to-amber-500 text-black"
                    >
                        {viewMode === '2d' ? '2D' : '3D'}
                    </button>
                </div>
            ...
            {/* Traffic Indicator */}
            <div className="absolute top-4 left-4 z-10 bg-black/90 backdrop-blur-xl rounded-xl px-4 py-3 border border-yellow-400/30 shadow-lg">
